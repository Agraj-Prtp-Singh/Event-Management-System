    ...
    <div className="flex relative">
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <button
            type="submit"
            className="btn w-full mt-2 bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-600 cursor-pointer font-semibold"
          >
            Log in
          </button>
          ...
          <button
            type="button"
            className="w-full flex items-center justify-center gap-2 border border-gray-300 bg-gray-100 hover:bg-gray-200 text-sm font-medium py-2 rounded-lg cursor-pointer transition-colors"
          >
